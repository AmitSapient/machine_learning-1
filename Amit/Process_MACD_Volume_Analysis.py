...
#        select_sql = "select symbol nseid from stocksdb.fo_mktlots sn "
        ...
        #Only amit_portfolio
#        select_sql = "select nseid from stocksdb.amit_portfolio sn where sn.is_inactive='n' order by nseid desc"        
#        select_sql = "select fullid, nseid from stocksdb.stock_names sn where nseid in ('KNRCON') "
...
#                liveDa1ta = self.module_Get_Live_Data_From_Google.getLiveQuotesForAStock(nseid)
